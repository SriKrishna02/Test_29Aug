...
import com.jgc.junit.spring.main.AppConfig;
...
public class JUnitSpringExample {
 ...
 assertEquals("class com.jgc.junit.spring.service.SampleServiceImpl",this.sampleService.getClass().toString());
